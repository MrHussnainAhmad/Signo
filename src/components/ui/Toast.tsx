...
function ToastItem({ toast, onRemove }: ToastItemProps) {
  ...
  return (
    <div
      ...
      role="alert"
    >
      <div className={`shrink-0 p-2 rounded-xl ${styles.iconBg}`}>{styles.icon}</div>
      ...
      <button
        ...
        className="shrink-0 p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-xl transition-colors"
      >
